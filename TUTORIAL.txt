...
The first loadout should use Slayer's Fang and the second should use Duality.
...
This temporarily limits the 30000 port for 18 seconds, then removes the limit
